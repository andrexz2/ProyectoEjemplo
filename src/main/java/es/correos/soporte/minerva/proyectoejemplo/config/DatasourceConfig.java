...
@EnableJpaRepositories(basePackages = "es.correos.soporte.minerva.proyectoejemplo.repository", excludeFilters = @ComponentScan.Filter(ReadOnlyRepository.class), entityManagerFactoryRef = "entityManagerFactory", transactionManagerRef = "transactionManager")
public class DatasourceConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(EntityManagerFactoryBuilder builder,
		...
		return builder.dataSource(dataSource).packages(entityManagerProperties.getPackagesToScan()).persistenceUnit("main")
				.properties(
	...
	public PlatformTransactionManager transactionManager(EntityManagerFactoryBuilder builder,
			@Qualifier("dataSource") DataSource dataSource, 
			@Qualifier("entityManagerProperties") EntityManagerProperties entityManagerProperties) {
		return new JpaTransactionManager(entityManagerFactory(builder, dataSource, entityManagerProperties).getObject());
	}
